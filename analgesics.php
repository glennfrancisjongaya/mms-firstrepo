<?php
include 'connection/connection.php'; // Include the file that establishes the database connection
...
<head>
  ...
  <script>
    $(document).ready(function() {
      // Add classes to make the table more appealing
      $("table").addClass("table-striped table-bordered table-hover");

      // Add DataTables functionality to the table
      $("table").DataTable({
  ...
  <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
    <div class="row g-3">
      <div class="col-xs-12">
        ...
        <a href="medicine.php" class="btn btn-primary float-end" style="margin-top: 10px">Back</a>
