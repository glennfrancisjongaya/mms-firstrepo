    ...
    <div class="container-fluid mt-4">
       <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-5 g-4">
            <?php
            $categories = [
                ["analgesics.php", "Analgesics", "medicines/analgesics.jpg"],
                ["antibiotics.php", "Antibiotics", "medicines/antibiotics.jpg"],
                ["antidepressants.php", "Antidepressants", "medicines/antidepressants1.jpg"],
                ["antihistamines.php", "Antihistamines", "medicines/antihistamines.jpg"],
                ["antacids.php", "Antacids", "medicines/antacids1.jpg"],
                ["anticoagulants.php", "Anticoagulants", "medicines/anticoagulants.jpg"],
                ["antidiabetic_drugs.php", "Antidiabetic Drugs", "medicines/antidiabetic1.jpg"],
                ["antipsychotics.php", "Antipsychotics", "medicines/antipsychotic4.jpg"],
                ["antivirals.php", "Antivirals", "medicines/antivirals.jpg"],
                ["bronchodilators.php", "Bronchodilators", "medicines/bronchodilators.jpg"]
            ];

            foreach ($categories as $category) {
            ?>
                <div class="col mb-4">
                    <a href="<?php echo $category[0]; ?>" class="card-link">
                        <div class="card h-100">
                            <img src="<?php echo $category[2]; ?>" class="card-img-top" alt="<?php echo $category[1]; ?> Image" style="height: 150px; object-fit: cover;">
                            <div class="card-body">
                                <h5 class="card-title text-center"><?php echo $category[1]; ?></h5>
                            </div>
                        </div>
                    </a>
                </div>
