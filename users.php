...
<div class="main-content" id="main-content">
      ...
      <div class="row g-3">
        <div class="col-mb-3">
          ...
          <div class="text-right">
            <a href="admin.php" class="btn btn-primary" style="margin-top: 10px">Back</a>
          </div>
  ...
  if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO tbl_system (Username, Password, Lastname, Firstname, ContactNo, Role) VALUES ('$username', '$password', '$lname', '$fname', '$contactno', '$role')";
    if ($conn->query($sql) === TRUE) {
      echo "<p class='text-success'>User has been added</p>";
    } else {
